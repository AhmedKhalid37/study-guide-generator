"""Public-safe tests for Slice 176W writer-generated table companion.
        ...
        "assets": [
            {
                ...
                "table_markdown": [_faithful_table()],
...
def _good_response() -> str:
    return (
        ...
        "| Variable | Meaning |\n| --- | --- |\n"
        f"| Age | {_RAW_SIMPL_CANARY} |\n| Outcome | Whether the patient survived |\n"
    )
...
def _run(text: str, tmp: str, render_html: bool = True) -> dict:
